...
C_DEPS += \
./COM_interpreter/Src/CH100_Interpreter.d \
...
COM_interpreter/Src/%.o: ../COM_interpreter/Src/%.c COM_interpreter/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32F405xx -DUSE_HAL_DRIVER -DDEBUG -c -I../Core/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/CMSIS/Include -I"D:/STM32_Projects/FourLineSerial/COM_interpreter/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"

clean: clean-COM_interpreter-2f-Src

clean-COM_interpreter-2f-Src:
	-$(RM) ./COM_interpreter/Src/CH100_Interpreter.d ./COM_interpreter/Src/CH100_Interpreter.o ./COM_interpreter/Src/JY901_Interpreter.d ./COM_interpreter/Src/JY901_Interpreter.o ./COM_interpreter/Src/Servo_Interpreter.d ./COM_interpreter/Src/Servo_Interpreter.o ./COM_interpreter/Src/raspi_Interpreter.d ./COM_interpreter/Src/raspi_Interpreter.o
